...
try: app_id = int(os.environ.get("app_id", "29563132"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "b39be032fc0c567d0cda60dbea99606e")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "7633082889:AAEfwvXEUu3C-MecV3pJoqoFql0J1kXVDXY")
